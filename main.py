...
#
# # Database setup
# DATABASE_URL = "postgresql://Nihal_DB:Nihal6565@database-2.c3gqwccykmdf.eu-north-1.rds.amazonaws.com:5432/tatanewdb"
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="172.18.100.33", port=8000)
